  <div class="col-lg-8 mx-auto p-4 py-md-5">
    <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FF69B4" class="bi bi-person-hearts"
          viewBox="0 0 16 16">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FF69B4" class="bi bi-flower1"
          viewBox="0 0 16 16">
          <path
        ...
        <span class="fs-4">&nbsp;Vicki's Machine Learning Garden</span>
      </a>
    </header>
